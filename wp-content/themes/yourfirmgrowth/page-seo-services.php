        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-7">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <button type="button" class="btn btn-brand btn-lg" data-bs-toggle="modal" data-bs-target="#yfgLeadModal">Get Your Free SEO Audit &rarr;</button> <?php yfg_whatsapp_button( 'ms-2' ); ?>
                </div>
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                ...
                <button type="button" class="btn btn-outline-brand" data-bs-toggle="modal" data-bs-target="#yfgLeadModal">Book a Strategy Call &rarr;</button> <?php yfg_whatsapp_button( 'ms-2' ); ?>
            </div>
...
<section class="yfg-section yfg-section--light">
    <div class="container">
        ...
        <div class="text-center mt-5">
            <button type="button" class="btn btn-brand btn-lg" data-bs-toggle="modal" data-bs-target="#yfgLeadModal">See Which SEO Services You Need &rarr;</button> <?php yfg_whatsapp_button( 'ms-2' ); ?>
        </div>
    </div>
</section>
...
<?php
// Portfolio strip — portfolio page ke "Organic Traffic Growth - SEO" wale selected results.
$yfg_pf_img = YFG_URI . '/assets/images/portfolio/';
get_template_part( 'template-parts/portfolio-strip', null, array(
	...
	'type'       => 'cards',
	'items'      => array(
		array( 'img' => $yfg_pf_img . 'image4.jpg', 'tag' => 'Forex & Finance', 'title' => 'Forex & CFD Broker Website', 'desc' => 'High-competition Forex & CFD market - aggressive SEO growth. We scaled the site to 8.15M impressions and 32.4K clicks through in-depth technical SEO, high-authority link building, and strategic content.' ),
		array( 'img' => $yfg_pf_img . 'image3.jpg', 'tag' => 'Germany', 'title' => 'Home Emergency Call System Provider', 'desc' => 'Germany-wide emergency services with a native German-language content and keyword strategy. Achieved 306K impressions and 3.93K clicks at a strong average position of 8.' ),
		array( 'img' => $yfg_pf_img . 'image6.png', 'tag' => 'Wholesale · USA', 'title' => 'Tire Wholesale Brand', 'desc' => 'SEO services for a tire wholesale brand in the USA, with results showing significant growth.' ),
		array( 'img' => $yfg_pf_img . 'image5.png', 'tag' => 'Internet Services · USA', 'title' => 'Rural Internet Services', 'desc' => 'SEO for a rural internet service provider in the USA, with results demonstrating significant growth.' ),
		array( 'img' => $yfg_pf_img . 'image7.png', 'tag' => 'eCommerce · USA', 'title' => 'Organic Baby Food Store', 'desc' => 'SEO and social media services for an organic baby food eCommerce website in the USA, resulting in strong online visibility.' ),
		array( 'img' => $yfg_pf_img . 'image8.png', 'tag' => 'eCommerce · USA', 'title' => 'Mushroom Gummies Brand', 'desc' => 'SEO and social media for a mushroom gummies eCommerce brand in the USA, driving increased visibility and consistent growth.' ),
	),
	'more_url'   => home_url( '/portfolio/#organic' ),
	'more_label' => 'See More SEO Portfolio',
) );
?>
...
<section class="yfg-section">
    <div class="container">
        ...
        <div class="text-center mt-5 pt-3">
            <button type="button" class="btn btn-brand btn-lg" data-bs-toggle="modal" data-bs-target="#yfgLeadModal">Request Your Proposal &rarr;</button> <?php yfg_whatsapp_button( 'ms-2' ); ?>
        </div>
    </div>
</section>
...
<section class="yfg-section">
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-7">
                <span class="yfg-accent yfg-accent--start"></span>
                <h2 class="yfg-section-title mb-3">Affordable SEO Services That Focus on Real Growth</h2>
                <p class="lead text-muted mb-4" style="font-size: 1.1rem; line-height: 1.6;">Strong SEO doesn't need an oversized budget. Our affordable SEO services focus on the work that can improve rankings, helping you gain traction early and build on those wins over time.</p>
                <p class="text-muted mb-4">As a transparent SEO partner, YFG keeps everything clear. You'll always know what's being done, why it matters, and how it's helping your business grow. No confusing reports, long-term lock-ins, or empty promises, just steady progress and a stronger marketing system that helps reduce customer acquisition costs over time.</p>
                <button type="button" class="btn btn-brand btn-lg" data-bs-toggle="modal" data-bs-target="#yfgLeadModal">Get a Custom SEO Quote &rarr;</button> <?php yfg_whatsapp_button( 'ms-2' ); ?>
            </div>
            <div class="col-lg-5 text-center">
                <div class="position-relative d-inline-block">
                    <div class="yfg-deco-dots yfg-deco-dots--top-left"></div>
...
<section class="yfg-section text-center">
    <div class="container">
        <div class="yfg-action-banner text-center text-white" style="background: linear-gradient(135deg, #03182e 0%, #052f57 50%, #04505c 100%); border-radius: 24px; padding: 4rem 2rem; box-shadow: 0 15px 40px rgba(3, 24, 46, 0.15);">
            ...
            <button type="button" class="btn btn-light btn-lg fw-semibold px-4 py-3" style="border-radius: 8px; transition: all 0.3s ease; box-shadow: 0 8px 20px rgba(255, 255, 255, 0.1);" data-bs-toggle="modal" data-bs-target="#yfgLeadModal">Get Your Free SEO Audit &rarr;</button> <?php yfg_whatsapp_button( 'ms-2' ); ?>
