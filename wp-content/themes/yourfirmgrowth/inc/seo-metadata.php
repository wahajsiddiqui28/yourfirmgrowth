...
function yfg_custom_page_titles( $title_parts ) {
    if ( is_page_template( 'page-seo-services.php' ) ) {
        ...
        $title_parts['title'] = 'About Your Firm Growth | Full-Service Digital Agency';
    } elseif ( is_page( 'gdpr-compliance' ) ) {
        $title_parts['title'] = 'GDPR Compliance | Your Firm Growth';
    } elseif ( is_page( 'privacy-policy' ) ) {
        $title_parts['title'] = 'Privacy Policy | Your Firm Growth';
    }
    return $title_parts;
}
...
function yfg_custom_page_meta() {
    ...
    if ( is_page_template( 'page-seo-services.php' ) ) {
        ...
        $desc = 'Learn about Your Firm Growth (YFG), a full-service digital agency helping businesses worldwide grow with SEO, web, marketing & more. GDPR compliant.';
        $og_title = 'About Your Firm Growth | Full-Service Digital Agency';
        $og_desc = 'We\'re YFG, a full-service digital agency turning opportunities into measurable growth for businesses worldwide. GDPR compliant. Remote teams in your hours.';
        $canonical = home_url( '/about-us' );
    } elseif ( is_page( 'gdpr-compliance' ) ) {
        $desc = 'How Your Firm Growth (YFG) complies with the GDPR & UK GDPR — data protection principles, security measures, your rights, and our controller/processor roles.';
        $og_title = 'GDPR Compliance | Your Firm Growth';
        $og_desc = 'YFG is committed to GDPR & UK GDPR compliance — privacy-first practices across every campaign, website, and data process we build.';
        $canonical = home_url( '/gdpr-compliance' );
    } elseif ( is_page( 'privacy-policy' ) ) {
        $desc = 'Read Your Firm Growth\'s Privacy Policy — what personal data we collect, how we use and protect it, and your rights under the GDPR and UK GDPR.';
        $og_title = 'Privacy Policy | Your Firm Growth';
        $og_desc = 'How YFG collects, uses, shares, and safeguards personal data — and your data-protection rights under the GDPR and UK GDPR.';
...
function yfg_custom_page_schemas() {
    ...
    if ( is_page_template( 'page-seo-services.php' ) ) {
        ...
        $schema = array(
            '@context' => 'https://schema.org',
            '@type' => 'AboutPage',
            'url' => 'https://yourfirmgrowth.com/about-us',
            'mainEntity' => array(
                '@type' => 'Organization',
                'name' => 'Your Firm Growth',
                'alternateName' => 'YFG',
                'url' => 'https://yourfirmgrowth.com',
                'email' => 'info@yourfirmgrowth.com',
                'description' => 'Full-service digital agency offering SEO, web design & development, content marketing, paid advertising, branding, CRO, automation, and growth consulting for businesses worldwide.',
                'areaServed' => array( 'United Kingdom', 'United States', 'Germany', 'Europe', 'Worldwide' ),
                'sameAs' => array( 'https://www.linkedin.com/company/yourfirmgrowth' )
            )
        );
        $faqs = array(
            array( 'What does Your Firm Growth do?', 'Your Firm Growth is a full-service digital agency offering SEO, web design and development, content marketing, paid advertising, branding, conversion optimization, automation, and growth consulting, all under one roof.' ),
            array( 'Who does YFG work with?', 'We partner with startups, small businesses, and established companies across the UK, US, Germany, Europe, and worldwide markets.' ),
            array( 'Is Your Firm Growth GDPR compliant?', 'Yes. Your Firm Growth is GDPR compliant and follows privacy-first practices across every engagement.' )
        );
    }
