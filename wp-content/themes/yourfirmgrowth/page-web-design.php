        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-7">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <button type="button" class="btn btn-brand btn-lg" data-bs-toggle="modal" data-bs-target="#yfgLeadModal">Get a Website Quote &rarr;</button> <?php yfg_whatsapp_button( 'ms-2' ); ?>
                </div>
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                ...
                <button type="button" class="btn btn-outline-brand" data-bs-toggle="modal" data-bs-target="#yfgLeadModal">Book a Discovery Call &rarr;</button> <?php yfg_whatsapp_button( 'ms-2' ); ?>
            </div>
...
<section class="yfg-section yfg-section--light">
    <div class="container">
        ...
        <div class="text-center mt-5">
            <button type="button" class="btn btn-brand btn-lg" data-bs-toggle="modal" data-bs-target="#yfgLeadModal">Start Your Website Project &rarr;</button> <?php yfg_whatsapp_button( 'ms-2' ); ?>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-7">
                ...
                <button type="button" class="btn btn-brand btn-lg" data-bs-toggle="modal" data-bs-target="#yfgLeadModal">Get a Custom Website Quote &rarr;</button> <?php yfg_whatsapp_button( 'ms-2' ); ?>
            </div>
            <div class="col-lg-5 text-center">
                <div class="position-relative d-inline-block">
                    <div class="yfg-deco-dots yfg-deco-dots--top-left"></div>
...
<?php
// Portfolio strip — portfolio page ke Web Development shots mein se 3.
$yfg_pf_web = YFG_URI . '/assets/images/web-dev-portfolio/web-development/';
get_template_part( 'template-parts/portfolio-strip', null, array(
	'title'      => 'Websites We\'ve Designed & Built',
	'sub'        => 'Fast, conversion-focused websites we\'ve designed and built across industries. Hover to preview the full page, or click to view.',
	'type'       => 'web',
	'items'      => array(
		array( 'img' => $yfg_pf_web . 'portfolio1.webp', 'title' => 'Website Project' ),
		array( 'img' => $yfg_pf_web . 'portfolio2.webp', 'title' => 'Website Project' ),
		array( 'img' => $yfg_pf_web . 'portfolio3.webp', 'title' => 'Website Project' ),
	),
	'more_url'   => home_url( '/portfolio/#web-development' ),
...
<section class="yfg-section text-center">
    <div class="container">
        <div class="yfg-action-banner text-center text-white" style="background: linear-gradient(135deg, #03182e 0%, #052f57 50%, #04505c 100%); border-radius: 24px; padding: 4rem 2rem; box-shadow: 0 15px 40px rgba(3, 24, 46, 0.15);">
            ...
            <button type="button" class="btn btn-light btn-lg fw-semibold px-4 py-3" style="border-radius: 8px; transition: all 0.3s ease; box-shadow: 0 8px 20px rgba(255, 255, 255, 0.1);" data-bs-toggle="modal" data-bs-target="#yfgLeadModal">Get Your Free Website Quote &rarr;</button> <?php yfg_whatsapp_button( 'ms-2' ); ?>
