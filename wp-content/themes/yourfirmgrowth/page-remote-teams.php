        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-7">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <button type="button" class="btn btn-brand btn-lg" data-bs-toggle="modal" data-bs-target="#yfgLeadModal">Hire Your Dedicated Team &rarr;</button> <?php yfg_whatsapp_button( 'ms-2' ); ?>
                </div>
...
<section class="yfg-section text-center">
    <div class="container">
        <div class="yfg-action-banner text-center text-white" style="background: linear-gradient(135deg, #03182e 0%, #052f57 50%, #04505c 100%); border-radius: 24px; padding: 4rem 2rem; box-shadow: 0 15px 40px rgba(3, 24, 46, 0.15);">
            ...
            <button type="button" class="btn btn-light btn-lg fw-semibold px-4 py-3" style="border-radius: 8px; transition: all 0.3s ease; box-shadow: 0 8px 20px rgba(255, 255, 255, 0.1);" data-bs-toggle="modal" data-bs-target="#yfgLeadModal">Hire Your Dedicated Team &rarr;</button> <?php yfg_whatsapp_button( 'ms-2' ); ?>
