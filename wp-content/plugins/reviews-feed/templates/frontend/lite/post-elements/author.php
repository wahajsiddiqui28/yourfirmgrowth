...
<div class="sb-item-author-date-ctn sb-fs">
	<div class="sb-item-author-ctn sb-relative">
		<div class="sb-item-name-date">
			...
			<span class="sb-item-author-name sb-relative" role="heading" aria-level="3"><?php echo sbr_neutralize_shortcodes(esc_html($this->parser->get_reviewer_name($post))); ?></span>
			<?php endif; ?>
